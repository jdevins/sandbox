...
export const definition = {
  id: 'response-data',
  name: 'Response Data',
  description: 'Data sources for this response\'s fields. Rows are free-form — add one per header or body field.',
  ...
  exampleCard: {
    kind: 'response-data',
    payload: { table: { columns: ['Field', 'Maps to'], rows: [
      ['Body: id', 'Maps to internal order record'],
    ] } },
  },
  actions: ['delete'],
  renderMode: 'inline',
